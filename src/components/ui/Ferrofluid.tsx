// Re-export the default export from the react-bits registry component.
// The full Ferrofluid source is maintained externally via the @react-bits namespace
// in components.json. Install with: pnpm dlx shadcn@latest add @react-bits/Ferrofluid-TS-TW
...
export interface FerrofluidProps {
  ...
  /** Pause the animation */
  paused?: boolean;
  /** Array of hex color strings (up to 8) */
  colors?: string[];
  /** Animation speed (default: 0.5) */
  speed?: number;
  /** Visual scale (default: 1.6) */
  scale?: number;
  /** Turbulence intensity (default: 1) */
  turbulence?: number;
  /** Fluid blending strength (default: 0.1) */
  fluidity?: number;
  /** Contour rim width (default: 0.2) */
  rimWidth?: number;
  /** Edge sharpness (default: 2.5) */
  sharpness?: number;
  /** Shimmer effect intensity (default: 1.5) */
  shimmer?: number;
  /** Glow intensity (default: 2) */
  glow?: number;
  /** Base flow direction: 'up' | 'down' | 'left' | 'right' */
  flowDirection?: 'up' | 'down' | 'left' | 'right';
  /** Overall opacity (default: 1) */
  opacity?: number;
  /** Enable mouse interaction (default: true) */
  mouseInteraction?: boolean;
  /** Mouse magnetic pull strength (default: 1) */
  mouseStrength?: number;
  /** Mouse interaction radius (default: 0.35) */
  mouseRadius?: number;
  /** Mouse dampening factor (default: 0.15) */
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      if (mouseDampening > 0) {
        ...
        cur[0] = cur[0] + (target[0] - cur[0]) * factor;
        cur[1] = cur[1] + (target[1] - cur[1]) * factor;
      } else {
        lastTimeRef.current = t;
      }
