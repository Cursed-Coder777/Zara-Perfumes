  ...
  return (
    ...
    >
      ...
      <div className="aspect-[3/4] bg-neutral-100 dark:bg-neutral-900 overflow-hidden">
        {images[0] ? (
          ...
          <div className="flex h-full items-center justify-center">
            <span className="font-serif text-6xl text-neutral-300 dark:text-neutral-700">
              Z
            </span>
          </div>
        )}
      ...
      <div className="flex flex-col gap-1">
        <h3 className="font-serif text-lg tracking-tight group-hover:opacity-60 transition-opacity">
          {name}
        </h3>
