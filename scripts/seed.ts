  ...
  const products = [
    {
      ...
      slug: "noir-extreme",
      description:
        "An intense and seductive fragrance that captures the essence of the night. Notes of black vanilla, cardamom, and amber create a warm, mysterious aura that lingers.",
      price: 9500,
      sizes: [
        { ml: 30, price: 6500 },
        { ml: 50, price: 9500 },
    ...
    },
    {
      ...
      slug: "azure-bloom",
      description:
        "A fresh aquatic floral that evokes the feeling of a Mediterranean breeze. Top notes of sea salt and bergamot give way to a heart of jasmine and lily.",
      price: 8500,
      sizes: [
        { ml: 30, price: 5500 },
        { ml: 50, price: 8500 },
    ...
    },
    {
      ...
      slug: "santal-royal",
      description:
        "A regal woody fragrance built around rare Mysore sandalwood. Blended with cedar, leather, and a hint of saffron for a sophisticated, timeless appeal.",
      price: 12000,
      sizes: [
        { ml: 30, price: 7500 },
        { ml: 50, price: 12000 },
    ...
    },
    {
      ...
      slug: "citrus-mist",
      description:
        "An invigorating burst of Sicilian citrus blended with fresh herbs and a touch of ginger. Perfect for the modern individual who lives life with energy.",
      price: 7000,
      sizes: [
        { ml: 30, price: 4500 },
        { ml: 50, price: 7000 },
    ...
    },
    {
      ...
      slug: "velvet-oud",
      description:
        "A luxurious oriental fragrance that combines rare oud with rose absolute and dark chocolate. Deep, complex, and utterly captivating.",
      price: 15000,
      sizes: [
        { ml: 30, price: 9500 },
        { ml: 50, price: 15000 },
    ...
    },
    {
      ...
      slug: "morning-dew",
      description:
        "Capture the freshness of early morning with this delicate floral-green fragrance. Dewy violet leaves, fresh-cut grass, and soft white musk.",
      price: 7800,
      sizes: [
        { ml: 30, price: 4800 },
        { ml: 50, price: 7800 },
    ...
    },
    {
      ...
      description:
        "A bold woody fragrance inspired by the crackling warmth of a fireside. Smoky birch, guaiac wood, and roasted tonka bean create an unforgettable trail.",
      price: 10500,
      sizes: [
        { ml: 30, price: 6500 },
        { ml: 50, price: 10500 },
    ...
    },
    {
      ...
      slug: "ocean-whisper",
      description:
        "A fresh marine scent that transports you to a secluded beach. Salty air, driftwood, and aquatic notes blend with a hint of coconut for a tropical escape.",
      price: 8200,
      sizes: [
        { ml: 30, price: 5200 },
        { ml: 50, price: 8200 },
